...
/* harmony import */ var _RoundThree_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./RoundThree.js */ "./src/RoundThree.js");
...
class Game {
  ...
  start() {
    this.getRandomData();
    this.createRound();
    this.createPlayers(_domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].grabNames());
  }

  createPlayers(array) {
    this.round.players = array.map(person => {
      return person = new _Player_js__WEBPACK_IMPORTED_MODULE_0__["default"](person);
    });
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].loadGameBoard(this.round.players);
    this.round.sortClues(this);
  }
  getRandomData () {
    this.allData.forEach((cat, ind) => {
      _data_js__WEBPACK_IMPORTED_MODULE_3__["default"].clues.forEach(clue => { 
  ...
  createRound (players) {
    ...
    if (this.roundCount === 1) {
      this.round = new _Round_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.clueSet());
    } else if (this.roundCount === 2) {
      this.round = new _Round_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.clueSet(), players)
      _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].newRound();
      this.round.sortClues();
    } else {
      this.round = new _RoundThree_js__WEBPACK_IMPORTED_MODULE_4__["default"](this.allData, players);
      this.round.grabClue(this.round);
      this.round.displayRound();
      _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].updateGameInfo(this);
    }
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].updateGameInfo(this);
  }
  clueSet () {
  ...
  boardListener (e) {
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].gameBoardListener(e, this);
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].updateGameInfo(this);
  }
  reset () {
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].resetGame();
  }
}
...
class Round {
  ...
  sortClues () {
    ...
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayCategories(this);
    this.setPlayer();
    this.dDouble = this.ddTurn()
  }
  guessButton () {
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].checkGuess(this, this.currentPlayer, this.wager);
  }
  setPlayer() {
    this.currentPlayer = this.players[this.playerInd]
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].activePlayer(this);
    if (this.playerInd === 2) {
      this.playerInd = 0;
      return
    }
  ...
  gameRotation(game) {
    this.turn--;
    this.setPlayer();
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].returnBoard();
    if (this.turn === 0) {
  ...
  dailyDouble (e, game) {
    ...
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].dailyDouble(e, game);
  }
}
...
class RoundThree extends _Round_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(baseData = [], players = []) {
  ...
  displayRound () {
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].roundThree(this);
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayCategories(this)
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_1__["default"].activePlayer(this)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = (RoundThree);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  grabNames () {
    let players = ([jquery__WEBPACK_IMPORTED_MODULE_1___default()('#player1').val(), jquery__WEBPACK_IMPORTED_MODULE_1___default()('#player2').val(), jquery__WEBPACK_IMPORTED_MODULE_1___default()('#player3').val()]);
    return players;
  },
  loadGameBoard (arr) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.game').removeClass('none');
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.intro-page').addClass('none');
    arr.forEach((player, ind) => {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('#player' + ([ind + 1]) + '-name-text').text(player.name);
    })
  },
  displayCategories (round) {
    ...
    round.roundClues.forEach((cat, ind) => {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(`.cat-${ind}`).text(topics[catId])
    });
  },
  ...
  addQuestionDom(currentQuestion) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.game').addClass('none');
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.clue').removeClass('none');
    var currentClue = `
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(".clue").html(currentClue);
  },
  checkGuess(round, player) {
    ...
    if (questionAnswer === jquery__WEBPACK_IMPORTED_MODULE_1___default()('.guess-text').val().toLowerCase() || jquery__WEBPACK_IMPORTED_MODULE_1___default()('.guess-text').val().toLowerCase() === 'jesus') {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.clue').html(correctAnswer);
      player.score += parseInt(wager) || clue.pointValue;
      round.wager = undefined;
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.clue').html(wrongAnswer);
      player.score -= parseInt(wager) || clue.pointValue;
      round.wager = undefined;
    }
  ...
  activePlayer (round) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.player-square').removeClass('active')
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(`.player-square.${round.playerInd}`).addClass('active');
    if (round.finalClue) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.player-square').addClass('active')
    }
  },
  returnBoard() {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.game').removeClass('none');
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.clue').addClass('none');
  },
  updateScores(round) {
    round.players.forEach((player, ind) => {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(`#player-${ind}-total`).html(`
        <h4 class="player-score" id="player-${ind}-total">Score: ${player.score} </h4>
      `);
    })
  },
  newRound () {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.box').removeClass('question-used');
  },
  dailyDouble (e, game) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(".clue").html(wagerBubble);
    let that = this;
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.wager-button').on('click', () => {
      game.round.wager = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.wager-text').val();
  ...
  updateGameInfo(game) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.turn-area').html(counter);
    let roundBtn = `<button class="round-button">Current Round ${game.roundCount}</button></section>`;
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.current-round').html(roundBtn);
  ...
  roundThree(round) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.question-box-area').html(finalWager);
    round.players.forEach((player, ind) => {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(`.player-${ind}`).text(player.name)
    })
    let that = this;
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.final-wager-button').on('click', () => {
      round.players[0].wager = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.player.0.wager').val()
      round.players[1].wager = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.player.1.wager').val()
      round.players[2].wager = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.player.2.wager').val()
  ...
  roundThreeQuestion(round) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.question-box-area').html(finalQuestion);
    round.players.forEach((player, ind) => {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(`.player-${ind}`).text(player.name)
    })
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.final-submit-button').on('click', () => {
      round.players[0].answer = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.player.0.guess').val();
      round.players[1].answer = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.player.1.guess').val();
      round.players[2].answer = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.player.2.guess').val();
  ...
  finalAnswer(round) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.question-box-area').html(finalWinner);
    this.updateScores(round);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.final-winner-button').on('click', () => {
      this.winner(round);
    })
  },
  winner (round) {
...
module.exports = "images/player1.svg";
...
module.exports = "images/player2.svg";

/***/ }),

/***/ "./src/images/player3.svg":
/*!********************************!*\
  !*** ./src/images/player3.svg ***!
  \********************************/
/*! no static exports found */
...
module.exports = "images/player3.svg";
...
/* harmony import */ var _css_base_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./css/base.css */ "./src/css/base.css");
/* harmony import */ var _css_base_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_css_base_css__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _images_player1_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./images/player1.svg */ "./src/images/player1.svg");
/* harmony import */ var _images_player1_svg__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_images_player1_svg__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _images_player2_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./images/player2.svg */ "./src/images/player2.svg");
/* harmony import */ var _images_player2_svg__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_images_player2_svg__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _images_player3_svg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./images/player3.svg */ "./src/images/player3.svg");
/* harmony import */ var _images_player3_svg__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_images_player3_svg__WEBPACK_IMPORTED_MODULE_9__);
...
jquery__WEBPACK_IMPORTED_MODULE_6___default()('.start-game').on('click', (e) => {
  e.preventDefault();
  game = new _Game_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
  game.start();
});

jquery__WEBPACK_IMPORTED_MODULE_6___default()('.box').on('click', (e) => {
...
jquery__WEBPACK_IMPORTED_MODULE_6___default()('.clue').on('click', () => {
...
jquery__WEBPACK_IMPORTED_MODULE_6___default()('#reset-button').on('click', () => {
  game.reset();
})
